...
```
![INNER JOIN](Screenshots/SQL_Joins/1.INNER%20JOIN.png)
...
```
![RIGHT INNER JOIN](Screenshots/SQL_Joins/3.RIGHT%20INNER%20JOIN.png)
...
```
![SELF JOIN](Screenshots/SQL_Joins/5.SELF%20JOIN.png)
...
WHERE rank_no <= 3;
```
![Ranking function](Screenshots/SQL_Window_functions/1.Ranking%20function.png)
...
```
![Navigate function](Screenshots/SQL_Window_functions/3.Navigate%20function.png)
...
```
![Distribution function](Screenshots/SQL_Window_functions/4.Distribution%20function.png)
